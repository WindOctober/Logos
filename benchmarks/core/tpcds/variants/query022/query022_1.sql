-- start query 1 in stream 0 using template ../query_variants/query22a.tpl
with results as 
...
from results)
 select top 100 i_product_name, i_brand, i_class, i_category,qoh
      from results_rollup
      order by qoh, i_product_name, i_brand, i_class, i_category
;

-- end query 1 in stream 0 using template ../query_variants/query22a.tpl
