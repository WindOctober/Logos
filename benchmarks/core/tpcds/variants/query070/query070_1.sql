-- start query 1 in stream 0 using template ../query_variants/query70a.tpl
with results as
( select
...
(select total_sum ,s_state ,s_county, 0 as g_state, 0 as g_county, 0 as lochierarchy from results
 ...
 select sum(total_sum) as total_sum ,NULL as s_state ,NULL as s_county, 1 as g_state, 1 as g_county, 2 as lochierarchy from results)
  select top 100 total_sum ,s_state ,s_county, lochierarchy 
  ,rank() over (
...
-- end query 1 in stream 0 using template ../query_variants/query70a.tpl
