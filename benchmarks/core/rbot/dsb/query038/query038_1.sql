...
FROM (SELECT *
            FROM (SELECT "customer"."c_last_name", "customer"."c_first_name", "date_dim"."d_date"
                        FROM "store_sales",
                            "date_dim",
                            "customer"
                        WHERE "store_sales"."ss_sold_date_sk" = "date_dim"."d_date_sk" AND "store_sales"."ss_customer_sk" = "customer"."c_customer_sk" AND ("date_dim"."d_month_seq" >= 1221 AND "date_dim"."d_month_seq" <= 1221 + 11) AND (("customer"."c_birth_month" = 2 OR "customer"."c_birth_month" = 8 OR "customer"."c_birth_month" = 10 OR "customer"."c_birth_month" = 11) AND "store_sales"."ss_list_price" >= 241 AND ("store_sales"."ss_list_price" <= 300 AND ("store_sales"."ss_wholesale_cost" >= 73 AND "store_sales"."ss_wholesale_cost" <= 93)))
                        ...
                        WHERE "catalog_sales"."cs_sold_date_sk" = "date_dim0"."d_date_sk0" AND "catalog_sales"."cs_bill_customer_sk" = "customer0"."c_customer_sk0" AND ("date_dim0"."d_month_seq0" >= 1221 AND "date_dim0"."d_month_seq0" <= 1221 + 11) AND (("customer0"."c_birth_month0" = 2 OR "customer0"."c_birth_month0" = 8 OR "customer0"."c_birth_month0" = 10 OR "customer0"."c_birth_month0" = 11) AND "catalog_sales"."cs_list_price" >= 241 AND ("catalog_sales"."cs_list_price" <= 300 AND ("catalog_sales"."cs_wholesale_cost" >= 73 AND "catalog_sales"."cs_wholesale_cost" <= 93)))
            ...
            WHERE "web_sales"."ws_sold_date_sk" = "date_dim1"."d_date_sk1" AND "web_sales"."ws_bill_customer_sk" = "customer1"."c_customer_sk1" AND ("date_dim1"."d_month_seq1" >= 1221 AND "date_dim1"."d_month_seq1" <= 1221 + 11) AND (("customer1"."c_birth_month1" = 2 OR "customer1"."c_birth_month1" = 8 OR "customer1"."c_birth_month1" = 10 OR "customer1"."c_birth_month1" = 11) AND "web_sales"."ws_list_price" >= 241 AND ("web_sales"."ws_list_price" <= 300 AND ("web_sales"."ws_wholesale_cost" >= 73 AND "web_sales"."ws_wholesale_cost" <= 93)))
