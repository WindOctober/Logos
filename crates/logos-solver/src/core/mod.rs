...
pub(crate) use syntax::{
    ...
    FormalQueryDefinitionGraph, FormalQueryError, FormalQueryExpr, FormalQueryStatementSymbols,
    FormalScalarExpr, FormalScalarSelectItem, FormalSchema, FormalSelectItem, LoweredProgram,
    LoweredQuery, ProofInputBindings, ProofLoweringReport, query_expr_output_signature,
};
#[cfg(test)]
