-- start query 1 in stream 0 using template ../query_variants/query18a.tpl
with results as
 (select i_item_id,
        ca_country,
        ca_state, 
 ...
 where cs_sold_date_sk = d_date_sk and
  ...
  select top 100 i_item_id, ca_country, ca_state, ca_county, agg1, agg2, agg3, agg4, agg5, agg6, agg7
 from (
...
-- end query 1 in stream 0 using template ../query_variants/query18a.tpl
