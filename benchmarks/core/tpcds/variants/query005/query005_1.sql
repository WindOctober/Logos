-- start query 1 in stream 0 using template ../query_variants/query5a.tpl
with ssr as
 (select s_store_id,
 ...
 group by channel, id)
 select top 100 channel, id, sales, returns, profit from ( 
...
-- end query 1 in stream 0 using template ../query_variants/query5a.tpl
