-- start query 1 in stream 0 using template ../query_variants/query14a.tpl
with  cross_items as
...
(select channel, i_brand_id, i_class_id, i_category_id, sum(sales) sum_sales, sum(number_sales) number_sales
 ...
 select top 100 channel, i_brand_id, i_class_id, i_category_id, sum_sales, number_sales
from (
...
-- end query 1 in stream 0 using template ../query_variants/query14a.tpl
