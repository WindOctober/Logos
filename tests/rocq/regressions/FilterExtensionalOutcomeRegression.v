...
Local Abbreviation filter_observation :=
  (@filter_formula_observation_equiv_at T relname basesort instance unknown
    symbol_runtime_error aggregate_runtime_error value_is_null).
...
Theorem ordered_filter_scheduler_regression :
  forall left_env left_formula left_rows
    ...
    (exists outcome,
      eval_filter_rows left_env left_formula left_rows outcome) ->
...
Theorem query_filter_extensional_regression :
  forall env left_formula right_formula left_input right_input,
    ...
    (exists outcome,
      eval_query env (QExpr_Filter left_formula left_input) outcome) ->
...
Print Assumptions filter_formula_observation_equiv_at_sym.
